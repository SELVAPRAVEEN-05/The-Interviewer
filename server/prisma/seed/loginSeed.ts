  ...
  const data = [
    {
      ...
      genderId: genders.find(g => g.value === "Male")?.id || genders[0]?.id || "",
      countryId: countries.find(c => c.name === "India")?.id || countries[0]?.id || "",
      languageId: languages.find(l => l.name === "English")?.id || languages[0]?.id || "",
      role: "admin",
    ...
    },
    {
      ...
      genderId: genders.find(g => g.value === "Other")?.id || genders[0]?.id || "",
      countryId: countries.find(c => c.name === "India")?.id || countries[0]?.id || "",
      languageId: languages.find(l => l.name === "English")?.id || languages[0]?.id || "",
      role: "user",
    ...
    },
    {
      ...
      genderId: genders.find(g => g.value === "Male")?.id || genders[0]?.id || "",
      countryId: countries.find(c => c.name === "India")?.id || countries[0]?.id || "",
      languageId: languages.find(l => l.name === "Hindi")?.id || languages[0]?.id || "",
      role: "candidate",
